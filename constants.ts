import { Badge, Scenario, TimelineEvent, MemoryCard, QuizQuestion } from "./types";
...
export const SCENARIOS: Scenario[] = [
  ...
  export const QUIZ_QUESTIONS: QuizQuestion[] = [
  {
    ...
    correctAnswer: 2,
    explanation: 'Hồ Chí Minh khẳng định CNXH trước hết nhằm giải phóng con người, mang lại tự do và hạnh phúc.'
  },
  {
    id: 'q2',
    question: 'Bản chất của chủ nghĩa xã hội theo Hồ Chí Minh là gì?',
    options: [
      'Sở hữu toàn dân',
      'Không còn bóc lột',
      'Nhà nước mạnh',
      'Dân giàu, nước mạnh, nhân dân hạnh phúc'
    ],
    correctAnswer: 3,
    explanation: 'Người nhấn mạnh CNXH là làm cho nhân dân ấm no, hạnh phúc.'
  },
  {
    id: 'q3',
    question: 'Theo Hồ Chí Minh, con người giữ vai trò nào trong CNXH?',
    options: [
      'Công cụ sản xuất',
    ...
    correctAnswer: 1,
    explanation: 'Con người vừa là mục tiêu, vừa là động lực của CNXH.'
  },
  {
    id: 'q4',
    question: 'Nhiệm vụ trung tâm trong xây dựng CNXH là gì?',
    options: [
      'Xây dựng văn hóa',
      'Phát triển kinh tế',
      'Củng cố quốc phòng',
    ...
    correctAnswer: 1,
    explanation: 'Phát triển kinh tế là nhiệm vụ trung tâm của thời kỳ xây dựng CNXH.'
  },
  {
    id: 'q5',
    question: 'Việt Nam quá độ lên CNXH từ xã hội nào?',
    options: [
      'Tư bản phát triển',
      'Phong kiến',
    ...
    correctAnswer: 3,
    explanation: 'Việt Nam đi lên CNXH từ một xã hội thuộc địa, nửa phong kiến.'
  },
  {
    id: 'q6',
    ...
    correctAnswer: 1,
    explanation: 'Xuất phát điểm thấp, lực lượng sản xuất lạc hậu là đặc điểm nổi bật.'
  },
  {
    id: 'q7',
    question: 'Thành phần kinh tế giữ vai trò chủ đạo trong CNXH là?',
    options: [
      'Kinh tế tư nhân',
      'Kinh tế tập thể',
      'Kinh tế quốc doanh',
    ...
    correctAnswer: 2,
    explanation: 'Kinh tế quốc doanh giữ vai trò chủ đạo.'
  },
  {
    id: 'q8',
    question: 'Theo Hồ Chí Minh, CNXH phải kết hợp hài hòa giữa?',
    options: [
      'Kinh tế và quân sự',
      'Kinh tế và văn hóa',
    ...
    correctAnswer: 2,
    explanation: 'CNXH không chỉ giàu vật chất mà còn phong phú tinh thần.'
  },
  {
    id: 'q9',
    question: 'Yếu tố nào được Hồ Chí Minh coi là động lực quan trọng để xây dựng CNXH?',
    options: [
      'Khoa học',
      'Vốn',
      'Con người',
    ...
    correctAnswer: 2,
    explanation: 'Con người là động lực quyết định.'
  },
  {
    id: 'q10',
    question: 'Theo Hồ Chí Minh, đạo đức giữ vai trò gì trong CNXH?',
    options: [
      'Thứ yếu',
      'Không quan trọng',
      'Nền tảng tinh thần',
    ...
    correctAnswer: 2,
    explanation: 'Đạo đức là nền tảng tinh thần của xã hội mới.'
  },

  {
    id: 'q11',
    question: 'Theo Hồ Chí Minh, Đảng Cộng sản giữ vai trò gì trong CNXH?',
    options: [
      'Quản lý kinh tế',
      'Lãnh đạo cách mạng',
    ...
    correctAnswer: 1,
    explanation: 'Đảng là nhân tố quyết định thắng lợi của CNXH.'
  },
  {
    id: 'q12',
    question: 'Theo Hồ Chí Minh, CNXH có thể thành công nếu thiếu đạo đức không?',
    options: ['Có', 'Không', 'Tùy điều kiện', 'Không rõ'],
    correctAnswer: 1,
    explanation: 'Không có đạo đức thì không thể xây dựng CNXH.'
  },
  {
    id: 'q13',
    question: 'Hồ Chí Minh cho rằng muốn xây dựng CNXH phải bắt đầu từ đâu?',
    options: [
      'Giáo dục',
      'Kinh tế',
      'Quân sự',
    ...
    correctAnswer: 1,
    explanation: 'Phải phát triển kinh tế làm nền tảng.'
  },
  {
    id: 'q14',
    question: 'Theo Hồ Chí Minh, động lực trực tiếp của CNXH là?',
    options: [
      'Giai cấp tư sản',
      'Giai cấp công nhân',
      'Giai cấp nông dân',
    ...
    correctAnswer: 1,
    explanation: 'Giai cấp công nhân là động lực trực tiếp.'
  },
  {
    id: 'q15',
    question: 'Theo Hồ Chí Minh, phải làm gì để phát huy động lực con người?',
    options: [
      'Cưỡng chế',
      'Khen thưởng',
    ...
    correctAnswer: 2,
    explanation: 'Phải gắn quyền lợi với trách nhiệm.'
  },

  {
    id: 'q16',
    question: 'Theo Hồ Chí Minh, độc lập dân tộc có ý nghĩa gì?',
    options: [
      'Điều kiện cần',
      'Điều kiện đủ',
      'Mục tiêu cuối cùng',
    ...
    correctAnswer: 3,
    explanation: 'Độc lập dân tộc là tiền đề để xây dựng CNXH.'
  },
  {
    id: 'q17',
    question: 'Hồ Chí Minh khẳng định độc lập dân tộc phải gắn liền với?',
    options: [
      'Dân chủ',
      'CNXH',
      'Kinh tế thị trường',
    ...
    correctAnswer: 1,
    explanation: 'Độc lập dân tộc gắn liền với CNXH.'
  },
  {
    id: 'q18',
    question: 'Theo Hồ Chí Minh, độc lập mà dân không được hưởng tự do, hạnh phúc thì?',
    options: [
      'Không có ý nghĩa',
      'Có ý nghĩa',
      'Là độc lập hoàn toàn',
      'Là độc lập hình thức'
    ],
    correctAnswer: 0,
    explanation: 'Độc lập phải mang lại hạnh phúc cho nhân dân.'
  },
  {
    id: 'q19',
    question: 'Chủ thể của cách mạng giải phóng dân tộc theo Hồ Chí Minh là?',
    options: [
      'Đảng',
      'Quân đội',
      'Nhân dân',
    ...
    correctAnswer: 2,
    explanation: 'Nhân dân là chủ thể của cách mạng.'
  },
  {
    id: 'q20',
    question: 'Theo Hồ Chí Minh, lực lượng nòng cốt của cách mạng là?',
    options: [
      'Nông dân',
      'Công nhân',
      'Trí thức',
    ...
    correctAnswer: 1,
    explanation: 'Giai cấp công nhân giữ vai trò nòng cốt.'
  },

  {
    id: 'q21',
    question: 'Theo Hồ Chí Minh, cách mạng giải phóng dân tộc phải đi theo con đường nào?',
    options: [
      'Tư sản',
      'Phong kiến',
      'XHCN',
    ...
    correctAnswer: 2,
    explanation: 'Cách mạng giải phóng dân tộc phải gắn với CNXH.'
  },
  {
    id: 'q22',
    question: 'Hồ Chí Minh cho rằng cách mạng Việt Nam có thể thắng trước cách mạng vô sản ở chính quốc không?',
    options: ['Có', 'Không', 'Tùy điều kiện', 'Không xác định'],
    correctAnswer: 0,
    explanation: 'Người khẳng định cách mạng thuộc địa có thể thắng trước.'
  },
  {
    id: 'q23',
    question: 'Theo Hồ Chí Minh, cách mạng giải phóng dân tộc phải do ai lãnh đạo?',
    options: [
      'Giai cấp tư sản',
      'Giai cấp phong kiến',
      'Đảng Cộng sản',
    ...
    correctAnswer: 2,
    explanation: 'Đảng Cộng sản là nhân tố quyết định.'
  },
  {
    id: 'q24',
    question: 'Theo Hồ Chí Minh, sức mạnh của cách mạng giải phóng dân tộc là?',
    options: [
      'Quân sự',
      'Kinh tế',
    ...
    correctAnswer: 2,
    explanation: 'Đại đoàn kết toàn dân là sức mạnh to lớn.'
  },
  {
    id: 'q25',
    question: 'Hồ Chí Minh khẳng định cách mạng là sự nghiệp của?',
    options: [
      'Đảng',
      'Quân đội',
      'Nhân dân',
    ...
    correctAnswer: 2,
    explanation: 'Cách mạng là sự nghiệp của nhân dân.'
  },

  {
    id: 'q26',
    question: 'Theo Hồ Chí Minh, cách mạng giải phóng dân tộc phải dùng phương pháp gì?',
    options: [
      'Hòa bình',
      'Bạo lực cách mạng',
      'Cải cách',
    ...
    correctAnswer: 1,
    explanation: 'Phải dùng bạo lực cách mạng chống lại bạo lực phản cách mạng.'
  },
  {
    id: 'q27',
    question: 'Theo Hồ Chí Minh, bạo lực cách mạng gồm?',
    options: [
      'Chính trị',
      'Quân sự',
    ...
    correctAnswer: 2,
    explanation: 'Bạo lực cách mạng là sự kết hợp của đấu tranh chính trị và quân sự.'
  },
  {
    id: 'q28',
    question: 'Theo Hồ Chí Minh, cách mạng giải phóng dân tộc phải gắn với?',
    options: [
      'Cách mạng tư sản',
      'Cách mạng XHCN',
      'Cách mạng cải lương',
    ...
    correctAnswer: 1,
    explanation: 'Giải phóng dân tộc gắn với CNXH.'
  },
  {
    id: 'q29',
    question: 'Theo Hồ Chí Minh, độc lập dân tộc là?',
    options: [
      'Mục tiêu tạm thời',
      'Mục tiêu cuối cùng',
      'Điều kiện cần',
    ...
    correctAnswer: 2,
    explanation: 'Độc lập là điều kiện cần để phát triển đất nước.'
  },
  {
    id: 'q30',
    question: 'Theo Hồ Chí Minh, CNXH ở Việt Nam phải phù hợp với?',
    options: [
      'Mô hình Liên Xô',
      'Mô hình Trung Quốc',
    ...
    correctAnswer: 2,
    explanation: 'Không rập khuôn máy móc mô hình nước ngoài.'
  },

  {
    id: 'q31',
    question: 'Theo Hồ Chí Minh, CNXH Việt Nam mang bản chất gì?',
    options: [
      'Dân tộc',
      'Nhân văn',
      'Dân tộc và nhân văn',
    ...
    correctAnswer: 2,
    explanation: 'CNXH mang tính dân tộc và nhân văn sâu sắc.'
  },
  {
    id: 'q32',
    question: 'Theo Hồ Chí Minh, muốn xây dựng CNXH phải có?',
    options: [
      'Kỷ luật',
      'Đạo đức cách mạng',
      'Vốn lớn',
    ...
    correctAnswer: 1,
    explanation: 'Đạo đức cách mạng là gốc.'
  },
  {
    id: 'q33',
    question: 'Hồ Chí Minh cho rằng cán bộ là?',
    options: [
      'Người quản lý',
      'Người chỉ huy',
      'Công bộc của dân',
    ...
    correctAnswer: 2,
    explanation: 'Cán bộ là công bộc của nhân dân.'
  },
  {
    id: 'q34',
    question: 'Theo Hồ Chí Minh, CNXH có đối lập với dân chủ không?',
    options: ['Có', 'Không', 'Tùy thời kỳ', 'Không xác định'],
    correctAnswer: 1,
    explanation: 'CNXH là dân chủ cao nhất.'
  },
  {
    id: 'q35',
    question: 'Theo Hồ Chí Minh, dân chủ trong CNXH là?',
    options: [
      'Hình thức',
      'Giả tạo',
      'Thực chất',
    ...
    correctAnswer: 2,
    explanation: 'Dân chủ XHCN là dân chủ thực chất.'
  },

  {
    id: 'q36',
    question: 'Theo Hồ Chí Minh, văn hóa trong CNXH có vai trò gì?',
    options: [
      'Phụ trợ',
      'Nền tảng tinh thần',
      'Thứ yếu',
    ...
    correctAnswer: 1,
    explanation: 'Văn hóa là nền tảng tinh thần.'
  },
  {
    id: 'q37',
    question: 'Theo Hồ Chí Minh, giáo dục nhằm mục tiêu gì?',
    options: [
      'Đào tạo lao động',
      'Nâng cao dân trí',
    ...
    correctAnswer: 2,
    explanation: 'Giáo dục con người phát triển toàn diện.'
  },
  {
    id: 'q38',
    question: 'Theo Hồ Chí Minh, CNXH có cần đoàn kết quốc tế không?',
    options: ['Có', 'Không', 'Tùy lúc', 'Không xác định'],
    correctAnswer: 0,
    explanation: 'CNXH gắn với tinh thần quốc tế.'
  },
  {
    id: 'q39',
    question: 'Theo Hồ Chí Minh, sức mạnh thời đại là?',
    options: [
      'Khoa học',
      'Đoàn kết quốc tế',
      'Quân sự',
    ...
    correctAnswer: 1,
    explanation: 'Đoàn kết quốc tế là sức mạnh thời đại.'
  },
  {
    id: 'q40',
    question: 'Theo Hồ Chí Minh, xây dựng CNXH là quá trình?',
    options: [
      'Ngắn hạn',
      'Lâu dài',
      'Nhanh chóng',
    ...
    correctAnswer: 1,
    explanation: 'Xây dựng CNXH là quá trình lâu dài.'
  },

  {
    id: 'q41',
    question: 'Theo Hồ Chí Minh, CNXH có đối lập với tôn giáo không?',
    options: ['Có', 'Không', 'Tùy điều kiện', 'Không rõ'],
    correctAnswer: 1,
    explanation: 'CNXH tôn trọng tự do tín ngưỡng.'
  },
  {
    id: 'q42',
    question: 'Theo Hồ Chí Minh, xây dựng CNXH phải dựa vào?',
    options: [
      'Nhà nước',
      'Đảng',
      'Nhân dân',
    ...
    correctAnswer: 2,
    explanation: 'CNXH là sự nghiệp của nhân dân.'
  },
  {
    id: 'q43',
    question: 'Theo Hồ Chí Minh, độc lập dân tộc có ý nghĩa với CNXH như thế nào?',
    options: [
      'Không liên quan',
    ...
    correctAnswer: 2,
    explanation: 'Độc lập là tiền đề để tiến lên CNXH.'
  },
  {
    id: 'q44',
    question: 'Theo Hồ Chí Minh, CNXH ở Việt Nam phải mang tính?',
    options: [
      'Quốc tế',
      'Dân tộc',
      'Nhân văn',
    ...
    correctAnswer: 3,
    explanation: 'CNXH Việt Nam mang bản sắc dân tộc và giá trị nhân văn.'
  },
  {
    id: 'q45',
    question: 'Theo Hồ Chí Minh, xây dựng CNXH cần tránh điều gì?',
    options: [
      'Chậm trễ',
      'Rập khuôn máy móc',
      'Học hỏi quốc tế',
    ...
    correctAnswer: 1,
    explanation: 'Phải sáng tạo, không rập khuôn mô hình nước ngoài.'
  },

  {
    id: 'q46',
    question: 'Theo Hồ Chí Minh, CNXH có cần đổi mới không?',
    options: ['Có', 'Không', 'Tùy giai đoạn', 'Không xác định'],
    correctAnswer: 0,
    explanation: 'CNXH phải luôn đổi mới sáng tạo.'
  },
  {
    id: 'q47',
    question: 'Theo Hồ Chí Minh, CNXH gắn liền với?',
    options: [
      'Hòa bình',
      'Công bằng',
      'Tiến bộ xã hội',
    ...
    correctAnswer: 3,
    explanation: 'CNXH gắn với hòa bình, công bằng và tiến bộ.'
  },
  {
    id: 'q48',
    question: 'Theo Hồ Chí Minh, thước đo của CNXH là?',
    options: [
      'GDP',
      'Sức mạnh quân sự',
      'Đời sống nhân dân',
    ...
    correctAnswer: 2,
    explanation: 'Đời sống nhân dân là thước đo CNXH.'
  },
  {
    id: 'q49',
    question: 'Theo Hồ Chí Minh, xây dựng CNXH phải đi đôi với?',
    options: [
      'Phát triển kinh tế',
      'Cải tạo xã hội cũ',
      'Xây dựng xã hội mới',
    ...
    correctAnswer: 3,
    explanation: 'Phải đồng thời cải tạo xã hội cũ và xây dựng xã hội mới.'
  },
  {
    id: 'q50',
    question: 'Theo Hồ Chí Minh, mục tiêu cuối cùng của cách mạng Việt Nam là?',
    options: [
      'Độc lập dân tộc',
      'CNXH',
    ...
    correctAnswer: 3,
    explanation: 'Độc lập, CNXH đều nhằm mục tiêu cao nhất là hạnh phúc nhân dân.'
  }
];
